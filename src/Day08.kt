...
private fun part1(instructions: List<Instruction>, isPart1: Boolean = true): Int {
    ...
    for (instruction in instructions) {
        ...
        when (comparatorOperator) {
            ComparatorOperator.EQUAL -> if (operand1Value == operand2) updateRegisterValue(
                operation,
                registers,
                register,
                amount
...
data class Instruction(
    ...
    val amount: Int,
    val operand1: String,
    val comparatorOperator: ComparatorOperator,
    val operand2: Int
)
...
private val parseInput = { input: List<String> ->
    ...
    buildList {
        for (instruction in input) {
            ...
            add(
                Instruction(
                    regexResult[0], regexResult[1], regexResult[2].toInt(), regexResult[3], when (regexResult[4]) {
